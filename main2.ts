...
function retornarPeliculaAsteriscos(tituloPelicula): string {
  ...
  function retornarPeliculaOculta(tituloPelicula: string, tituloPeliculaOculto) {
  ...
  const tituloPelicula = 'Indiana Jones';
  let tituloPeliculaOculto = retornarPeliculaAsteriscos(tituloPelicula);
  
  // se revela una letra
  
  setInterval(() => {
  tituloPeliculaOculto = retornarPeliculaOculta(tituloPelicula, tituloPeliculaOculto)
  console.log(tituloPeliculaOculto);
  }, 1000);